...
export const SHARED_STEPS: WalkthroughStep[] = [
  ...
  },
  {
    ...
    description: 'Start by creating a new session. Choose House Visit mode for on-site cataloging with photos, or Sale Cataloging mode for receipt-based entries.',
    icon: (
      <svg className={iconClassName} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    id: 'house-visit',
    title: 'House Visit Mode',
    description: 'Capture photos of each item with your device camera, then dictate a description. The AI extracts title, description, condition, estimate, and measurements.',
    icon: (
      <svg className={iconClassName} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
