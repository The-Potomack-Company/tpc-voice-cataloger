...
export function ItemPeekModal({ item, onClose }: ItemPeekModalProps) {
  ...
  return (
    <Modal
      ...
      bareOverlay
      overlayClassName="fixed inset-0 z-[60] bg-ink/40 px-4 py-8 flex items-end sm:items-center justify-center"
      panelClassName="w-full max-w-lg rounded-lg bg-bg border border-rule shadow-lg max-h-[85vh] overflow-auto"
    >
